...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@mukeshdas/sdkv1'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@mukeshdas/lquikit'
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    if (currencyA === ETHER || currencyB === ETHER) {
      console.log('IN IF', currencyB, currencyA)
